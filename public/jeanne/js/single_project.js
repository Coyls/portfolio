...
requestServer('getProjectLoic').then( response => {
    ...
    let nextProjectUrl = `${location}/jeanne/pages/single_project.html?projectId=${data[nextProjectIndex].id}`
    let previousProjectUrl = `${location}/jeanne/pages/single_project.html?projectId=${data[previousProjectIndex].id}`
