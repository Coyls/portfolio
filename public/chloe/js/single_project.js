...
requestServer('getProjectChloe').then( response => {
    ...
    let nextProjectUrl = `${location}/chloe/pages/single_project.html?projectId=${data[nextProjectIndex].id}`
    let previousProjectUrl = `${location}/chloe/pages/single_project.html?projectId=${data[previousProjectIndex].id}`
